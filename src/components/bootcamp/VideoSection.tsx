...
const VideoSection: React.FC = () => {
    ...
    return (
        <section ref={sectionRef} className="section-border py-20 px-4 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="relative rounded-3xl overflow-hidden group"
                    ...
                    <div className={`${isPlaying && isSticky && !isClosed
                            ? "fixed bottom-8 right-8 w-72 sm:w-80 z-[9999] shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_30px_hsl(199,100%,55%,0.2)] animate-in fade-in slide-in-from-bottom-10"
                        ...
                        {!isPlaying ? (
                            ...
                            <div className="relative w-full h-full group/player">
                                ...
                                {isSticky && !isClosed && (
                                    <div className="absolute inset-0 pointer-events-none border-2 border-primary/30 rounded-3xl z-10" />
                                )}
                            </div>
                        )}
                    </div>
