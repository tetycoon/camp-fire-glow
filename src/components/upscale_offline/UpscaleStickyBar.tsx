                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap lg:flex-nowrap items-center justify-center gap-4 sm:gap-6 lg:gap-10">
                    ...
                    <div className="flex items-center gap-3 group">
                        ...
                        <div className="whitespace-nowrap">
                            ...
                            <div className="text-sm font-black text-slate-900 leading-none mt-0.5">11th October 2026 (Sunday)</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 group">
                        ...
                        <div className="whitespace-nowrap">
                            ...
                            <div className="text-sm font-black text-slate-900 leading-none mt-0.5">9:00 AM - 5:30 PM</div>
                        </div>
                    </div>
