...
const AIMasterclass2Footer: React.FC = () => {
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 text-muted-foreground mb-4">
                            ...
                            <a href="mailto:antony@aitycoon.in" className="hover:text-emerald-400 text-sm font-body">antony@aitycoon.in</a>
                        </div>
...
export default AIMasterclass2Footer;
